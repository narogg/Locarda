...
class RegistrationsControllerTest < ActionController::TestCase
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post :create, registration: { gcm_reg_id: @registration.gcm_reg_id, user_id: @registration.user_id }
    end
  ...
  test "should update registration" do
    patch :update, id: @registration, registration: { gcm_reg_id: @registration.gcm_reg_id, user_id: @registration.user_id }
    assert_redirected_to registration_path(assigns(:registration))
  end
